...
public class BlastProperty implements IMaterialProperty {
    ...
    @Setter
    @Getter
    private long vacuumEUtOverride = -1;
    ...
    public BlastProperty(int blastTemperature, GasTier gasTier, long eutOverride, int durationOverride,
                         long vacuumEUtOverride, int vacuumDurationOverride) {
        this.blastTemperature = blastTemperature;
        this.gasTier = gasTier;
    ...
    public static class Builder {
         ...
         */
        public Builder blastStats(long eutOverride) {
            this.eutOverride = eutOverride;
            return this;
        }
         ...
         */
        public Builder blastStats(long eutOverride, int durationOverride) {
            this.eutOverride = eutOverride;
            this.durationOverride = durationOverride;
            return this;
        }
         ...
         */
        public Builder vacuumStats(long eutOverride) {
         ...
         */
        public Builder vacuumStats(long eutOverride, int durationOverride) {
            this.vacuumEUtOverride = eutOverride;
