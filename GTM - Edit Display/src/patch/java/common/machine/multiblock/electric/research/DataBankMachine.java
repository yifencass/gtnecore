...
public class DataBankMachine extends WorkableElectricMultiblockMachine
    ...
    public static final long EUT_PER_HATCH = GTValues.VA[GTValues.EV];
    public static final long EUT_PER_HATCH_CHAINED = GTValues.VA[GTValues.LuV];
    ...
    protected long calculateEnergyUsage() {
        int receivers = 0;
        int transmitters = 0;
        int regulars = 0;
    ...
    public void tick() {
        long energyToConsume = this.getEnergyUsage();
